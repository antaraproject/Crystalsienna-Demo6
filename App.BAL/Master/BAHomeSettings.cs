...
{
    public class BAHomeSettings : IHomeSetting
    {
        Int16 vCount = 0;
        DataSet ds = null;
        DataTable dt = null;
        ...
        public DataTable Get<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_GET_HEAD_HOME_SETTING", CommandType.StoredProcedure))
                {
        ...
        public Byte SaveChanges<T1, T2>(String pMode, EntityHomeSetting oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                para[vCount++].Value = 0;
                para[vCount] = new SqlParameter("@BANNER_IMG", SqlDbType.VarChar, 9000);
                para[vCount++].Value = oEntity.BANNER_IMG;
                para[vCount] = new SqlParameter("@ABOUT_DESC", SqlDbType.VarChar, 9000);
                para[vCount++].Value = oEntity.ABOUT_DESC;
                para[vCount] = new SqlParameter("@ABOUT_IMG", SqlDbType.VarChar, 100);
                para[vCount++].Value = oEntity.ABOUT_IMG;
                para[vCount] = new SqlParameter("@OFFER_IMG", SqlDbType.VarChar, 100);
                para[vCount++].Value = oEntity.OFFER_IMG;
                para[vCount] = new SqlParameter("@QUICK_FACT_IMG", SqlDbType.VarChar, 100);
                ...
                using (DBContext oDBC = new DBContext("SP_SAVE_HEAD_HOME_SETTING", CommandType.StoredProcedure))
                {
        ...
        public byte Delete<T>(String pMode, T pValue, ref T pKey, ref String pMsg, Int32 pUser, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                para[vCount].Direction = ParameterDirection.InputOutput;
                para[vCount++].Value = 0;
                para[vCount] = new SqlParameter("@DTLS_CAROUSEL_LINKS_KEY", SqlDbType.Int);
                para[vCount].Direction = ParameterDirection.InputOutput;
                para[vCount++].Value = pValue;
                para[vCount] = new SqlParameter("@EDIT_USER_KEY", SqlDbType.Int);
                para[vCount++].Value = pUser;

                using (DBContext oDBC = new DBContext("SP_DELETE_DTLS_CAROUSEL_LINKS", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
        ...
        public Byte SaveQuickFact<T1, T2>(String pMode, EntityHomeSetting oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount] = new SqlParameter("@QUICK_FACT_DESC", SqlDbType.VarChar, 700);
                para[vCount++].Value = oEntity.QUICK_FACT;
                para[vCount] = new SqlParameter("@COMPANY_KEY", SqlDbType.Int);
                para[vCount++].Value = oEntity.COMPANY_KEY;
        ...
        public DataTable GetQuickFact<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                vCount = 0;
        ...
        public byte QuickFactrDelete<T>(String pMode, T pValue, ref T pKey, ref String pMsg, Int32 pUser, String pAccYr, Int16? pCompany_key)
        {
            byte retKey = 0;
            try
            {
        ...
        public Byte SaveDelete<T1, T2>(String pMode, EntityHomeSetting oEntity, T1 pValue, ref T2 pKey, ref String pMsg, ref String pDelMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
