...
{
    public class BABlogCat : IBlogCat
    {
        Int16 vCount = 0;
        DataTable dt = null;
        ...
        public void BindLB(ref ListBox ddl, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (CommonOp oCommonOp = new CommonOp())
                {
                    oCommonOp.BindListBox("SP_GET_MAST_BLOG_CATEGORY", ref ddl, "MAST_BLOG_CATEGORY_KEY", "BLOG_CAT_DESC", ref pMsg, pAccYr, pCompany_key, para);
                }
            }
            catch (Exception ex)
            {
        ...
        public DataTable Get<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_GET_MAST_BLOG_CATEGORY", CommandType.StoredProcedure))
                {
        ...
        public Byte SaveChanges<T1, T2>(String pMode, EntityBlogCat oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_SAVE_MAST_BLOG_CATEGORY", CommandType.StoredProcedure))
                {
        ...
        public byte Delete<T>(String pMode, T pValue, ref T pKey, ref String pMsg, Int32 pUser, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_DELETE_MAST_BLOG_CATEGORY", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
