...
{
    public class BADtlsForum : IDtlsForum
    {
        Int16 vCount = 0;
        DataTable dt = null;
        ...
        public void BindDdl(ref DropDownList ddl, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                {
                    oCommonOp.BindDropDownList("SP_GET_DTLS_FORUM", ref ddl, "DTLS_FORUM_KEY", "FORUM_HEADING", ref pMsg, pAccYr, pCompany_key, para);
                }
            }
            catch (Exception ex)
            {
        ...
        public DataTable Get<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_GET_DTLS_FORUM", CommandType.StoredProcedure))
                {
        ...
        public Byte SaveChanges<T1, T2>(String pMode, EntityDtlsForum oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount++].Value = 0;
                para[vCount] = new SqlParameter("@DTLS_FORUM_KEY", SqlDbType.Int);
                para[vCount].Direction = ParameterDirection.InputOutput;
                para[vCount++].Value = oEntity.DTLS_FORUM_KEY;
                para[vCount] = new SqlParameter("@FORUM_HEADING", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.FORUM_HEADING;
                para[vCount] = new SqlParameter("@FORUM_DESC", SqlDbType.VarChar, 9000);
                para[vCount++].Value = oEntity.FORUM_DESC;
                para[vCount] = new SqlParameter("@FORUM_DATE", SqlDbType.SmallDateTime);
                para[vCount++].Value = oEntity.FORUM_DATE;
                para[vCount] = new SqlParameter("@FORUM_IMG", SqlDbType.VarChar, 100);
                para[vCount++].Value = oEntity.FORUM_IMG;
                ...
                using (DBContext oDBC = new DBContext("SP_SAVE_DTLS_FORUM", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
                    vRef = Convert.ToByte(oDBC.GetParameterValue("@RETURN_KEY", ref pMsg));
                    pKey = (T2)Convert.ChangeType(oDBC.GetParameterValue("@DTLS_FORUM_KEY", ref pMsg), typeof(T2));
                }
            }
            catch (Exception ex)
            {
        ...
        public Byte SaveDelete<T1, T2>(String pMode, EntityDtlsForum oEntity, T1 pValue, ref T2 pKey, ref String pMsg, ref String pDelMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_DELETE_DTLS_FORUM", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
                    vRef = Convert.ToByte(oDBC.GetParameterValue("@RETURN_KEY", ref pMsg));
                    pKey = (T2)Convert.ChangeType(oDBC.GetParameterValue("@DTLS_FORUM_KEY", ref pMsg), typeof(T2));
