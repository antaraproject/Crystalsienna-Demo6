...
{
    public class BAMstSubject : IMstSubject
    {
        Int16 vCount = 0;
        DataTable dt = null;
        ...
        public void BindDdl(ref DropDownList ddl, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                {
                    oCommonOp.BindDropDownList("SP_GET_MAST_SUBJECT", ref ddl, "MAST_SUBJECT_KEY", "SUB_NAME", ref pMsg, pAccYr, pCompany_key, para);
                }
            }
            catch (Exception ex)
            {
        ...
        public void BindLB(ref ListBox ddl, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (CommonOp oCommonOp = new CommonOp())
                {
                    oCommonOp.BindListBox("SP_GET_MAST_SUBJECT", ref ddl, "MAST_SUBJECT_KEY", "SUB_NAME", ref pMsg, pAccYr, pCompany_key, para);
                }
            }
            catch (Exception ex)
            {
        ...
        public void BindCategoryDdl(String pMode, ref DropDownList ddl, String pKey, ref String pMsg, string pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (CommonOp oCommonOp = new CommonOp())
                {
                    oCommonOp.BindCategoryDropDownList("SP_GET_MAST_SUBJECT", ref ddl, "MAST_SUBJECT_KEY", "SUB_NAME", ref pMsg, pAccYr, pCompany_key, para);
                }
            }
            catch (Exception ex)
            {
        ...
        public DataTable Get<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_GET_MAST_SUBJECT", CommandType.StoredProcedure))
                {
        ...
        public byte SaveChanges<T1, T2>(String pMode, EntitySubject oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount++].Value = 0;
                para[vCount] = new SqlParameter("@MAST_SUBJECT_KEY", SqlDbType.Int);
                para[vCount].Direction = ParameterDirection.InputOutput;
                para[vCount++].Value = oEntity.MAST_SUBJECT_KEY;
                para[vCount] = new SqlParameter("@SUB_CODE", SqlDbType.VarChar, 50);
                para[vCount++].Value = oEntity.SUB_CODE;
                para[vCount] = new SqlParameter("@SUB_NAME", SqlDbType.VarChar, 500);
                para[vCount++].Value = oEntity.SUB_NAME;
                ...
                using (DBContext oDBC = new DBContext("SP_SAVE_MAST_SUBJECT", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
                    vRef = Convert.ToByte(oDBC.GetParameterValue("@RETURN_KEY", ref pMsg));
                    pKey = (T2)Convert.ChangeType(oDBC.GetParameterValue("@MAST_SUBJECT_KEY", ref pMsg), typeof(T2));
                }
            }
            catch (Exception ex)
            {
        ...
        public Byte SaveDelete<T1, T2>(String pMode, EntitySubject oEntity, T1 pValue, ref T2 pKey, ref String pMsg, ref String pDelMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                using (DBContext oDBC = new DBContext("SP_DELETE_MAST_SUBJECT", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
                    vRef = Convert.ToByte(oDBC.GetParameterValue("@RETURN_KEY", ref pMsg));
                    pKey = (T2)Convert.ChangeType(oDBC.GetParameterValue("@MAST_SUBJECT_KEY", ref pMsg), typeof(T2));
