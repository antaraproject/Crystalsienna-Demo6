<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="testimonial.aspx.cs" 
    EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectSix.admin.master.testimonial" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 ml-auto mr-auto">
                                                <img id="img_Client" src="../../assets/images/no_image.jpg" class="form-control preview" runat="server" />
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
            ...
            $("#<%=fu_Client.ClientID %>").on("change", function (evt) {
                ...
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        ...
                        $('#<%=img_Client.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/assets/images/no_image.jpg")%>");
                        $(this).focus();
