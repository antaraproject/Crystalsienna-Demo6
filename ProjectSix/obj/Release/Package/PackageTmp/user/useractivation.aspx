<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="useractivation.aspx.cs" Inherits="ProjectSix.user.useractivation" %>
                              ...
                              <div class="col-sm-12">
                                 <article class="post format-small-image with_background">
                                    <div class="side-item content-padding">
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="item-media entry-thumbnail" runat="server" id="forgot_img">
                                                <%--<img src=""  alt="">--%>
                                             </div>
                                          </div>
                                          <div class="col-md-6 frgtcontent">
                                          ...
                                          <br />
                                            ...
                                            <button type="submit" runat="server" onserverclick="btn_verify_Click"  class="btn btn-primary">Verify OTP</button> <%--onserverclick="btn_login_Click"--%>
                                            <button type="submit" runat="server" onserverclick="btn_resend_Click"  class="btn btn-primary">Resend OTP</button>
                                              ...
                                              <br />
                                               <div class="clearfix text-center" id="div_Activation_Msg" runat="server"></div>
                                                <br />
                                                   <br />
                                                 <div class="text-center" >
                                                      <button type="submit" id="btn_login" runat="server" class="btn btn-primary" onserverclick="btn_login_Click" >Login</button>
