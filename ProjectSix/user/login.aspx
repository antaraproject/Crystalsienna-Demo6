<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ProjectSix.user.login" %>
...
.loginreg {
    ...
    <script>
        ...
        function popuperror() {
            swal("Oops", "Please Provide Proper Phone Number & Password!", "error")
        }
...
<body class="loginreg" style="background:url('/documents/seeting/20200929_120039-K.jpg');background-size:100% 100%;background-repeat:no-repeat;">
                    ...
                    <div class="regareain">
                        <div class="regareainfrm">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6">
                                    <div class="regareainfrmrightlog">

                                        <input type="text" runat="server" name="" id="txt_USER" class="form-control fld" placeholder="Phone Number">
                                        <input type="password" runat="server" name="" id="txt_PASS" class="form-control fld" placeholder="password">
                                          <span id="show_password" onclick="showedPass();" class="fa fa-eye-slash showpass icon toggle-password"></span>
                                        <input type="checkbox" id="login" name="login" value="Login">
                                        <label for="login">Remember Me</label><br>
                                        <a class="btn btn-extra-large btn-dark-gray text-large border-radius-4 md-margin-15px-bottom sm-display-table sm-margin-lr-auto width-one" runat="server" onserverclick="btn_login_Click">Login </a>
                                        <a href="<%=Page.ResolveClientUrl("~/user/reset_password.aspx/")%>" class="forgotpass">Forgot password</a>
