<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="ProjectSix.user.registration" %>
 ...
 <style>
   ...
   <script>
       function popup() {
           swal({
               title: "Successful!",
               text: "Your registration is successfull !!To activate your account please check your registered phone number.",
               icon: "success",
               button: "Ok",
           });
       }
       function popuperror() {
           swal("Oops", "Please Provide Proper Information !", "error")
       }
       ...
       function popuppasswordmatch() {
           swal({
               ...
               text: "Enter Proper Phone Number!!",
               icon: "error",
               button: "Ok",
           });
       }
...
<body class="regarea" style="background:url('/documents/seeting/20200929_120039-K.jpg');background-size:cover;background-position:left top;background-repeat: no-repeat;overflow: hidden;">
                        ...
                        <div class="regareainfrm">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6 regn-page-form">
                                    <div class="regareainfrmright">
                                        <div class="form-group">
                                        <input type="text" runat="server" name="" id="txt_NAME" class="form-control fld" placeholder="Name"/>
                                       </div>
                                         <%--<div class="form-group">
                                            <asp:DropDownList name="countryCode" ID="ddlcountry" EnableViewState="true" class="form-control fldnew fldnew-sel" runat="server"></asp:DropDownList>
                                             </div>--%>
                                        <div class="form-group" style="width: 104px;display: inline;float: left;"> 
                                            <asp:DropDownList name="countryCode" ID="ddlcountry" EnableViewState="true" class="form-control fldnew fldnew-sel" runat="server"></asp:DropDownList>
                                        

                                        </div>
                                        <div class="form-group" style="width: calc(100% - 110px); float: right;">
                                            <input type="text" aria-required="true" size="30" runat="server" value="" name="Phone" id="txt_Phone" class="form-control  fld text-center" style="min-width: auto;" placeholder="Phone Number"/>
                                        </div>
                                    <%--   <div class="form-group">
                                        <input type="text" runat="server" name="" id="txt_EMAIL" class="form-control fld" placeholder="Phone Number"/>
                                         </div>--%>
                                        <div class="form-group">
                                        <input type="password" runat="server" name="" id="txt_PASS" class="form-control fld" placeholder="password"/>
                                        <span id="show_password" runat="server" class="fa fa-eye-slash pass icon toggle-password"></span>
                                        </div>
                                        <a id="info" class="info popup-trigger btn btn-extra-large btn-dark-gray text-large border-radius-4 md-margin-15px-bottom sm-display-table sm-margin-lr-auto width-one" runat="server" onserverclick="btn_signup_Click">Register </a>
                                    ...
                                    <a href="<%=Page.ResolveClientUrl("~/")%>" class="backtohome">Back to home</a>
                                </div>
                            </div>
                            </div>
                        </div>
